...
// tmp var for technical_compliance
    ...
    lifetime: {
        ...
        autoform: {
            afFieldInput: {
                ...
                class:"tcc_lifetime" // makes it easier to select with d3js
            }
        }
    },
    conformity: {
        ...
        autoform: {
            type: "select",
            options: function () {
                return buildOptions(conformity_options);
            }
        }
    },
    description: {
...
Leases.attachSchema(new SimpleSchema({
    ...
    erp_status: {
        ...
        autoform: {
            type: "select",
            options: function() {
                return buildOptions(["erp_J", "erp_L", "erp_M", "erp_N", "erp_O", "erp_P", "erp_R", "erp_S", "erp_T", "erp_U", "erp_V", "erp_W", "erp_X", "erp_Y"])
            }
        }
    },
    erp_category: {
