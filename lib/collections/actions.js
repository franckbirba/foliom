...
Actions.attachSchema(new SimpleSchema({
    ...
    impact_assessment_fluids: {
        type: [Object],
        label: transr("impact_assessment_fluids"),
        optional:true,
    },
    'impact_assessment_fluids.$.opportunity': {
        type: String,
        ...
        autoform: {
            type: "select",
                options: function() {
                    ...
                    //         //For each lease, extract the endUse
                    //         _.each(lease.consumption_by_end_use, function(entry, i) {
                    //                 // ToDo - Problem: using Transr loses the selected value...
                    //                 var end_use_by_lease = lease.lease_name + " - " + transr(entry.end_use_name)();
                    //                 endUseListByLease.push(end_use_by_lease);
                    //         });

                    //     });
                    //     return buildOptions(endUseListByLease);
                    // } else {
                    //     return buildOptions(["D", "E", "F"]);
                    // }
        ...
        //     type: "select",
        //     options: function() {
        //         return buildOptions(["classic", "cpe", "cr", "crem", "ppp", "cpi"]);
        //     }
        // }
    },
    'impact_assessment_fluids.$.per_cent': {
        type: String,
    ...
    'impact_assessment_fluids.$.or_kwhef': {
        type: String,
    ...
    'impact_assessment_fluids.$.yearly_savings': {
        type: String,
